...
**Note:** This doesn't include evolved Pokemon or Pokemon added via other datapacks, only base form Pokemon within Cobblemon v1.7. This also doesn't include the regional bias Pokemon added, so Hisuian Rowlet doesn't have an outbreak. From the testing I did, they didn't seem to work.
